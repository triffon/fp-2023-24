...
6. Напишете функция `(main-diagonal m)`, която връща главния диагонал на матрицата `m`.
...
12. Напишете функция `(multiply m1 m2)`, която
  връща произведението на двете матрици `m1` и `m2`.

13. Напишете функция `(find-columns m)`, която
...
4. Напишете функция `(height)`, която намира височината на дървото `t`. Това е броят на върховете в най-дългия път.
...
9. Напишете функция `(bst? t)`, която намира дали `t` двоично **наредено** дърво.
...
11. Двоично дърво е балансирано, ако:
...
5. Напишете функция, която композира два асоциативни списъка с целочислени ключове и стойности, разглеждайки ги като функции.
   Пример:
...
6. Напишете функция `(group-by f l)`, която
...
7. Напишете функция `(run-length-encode l)`, която
...
8. Напишете функция `(run-length-decode code)`, която
